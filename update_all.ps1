...
$Options = [ordered]@{
    ...
    Push          = $Env:au_Push -eq 'true'                 #Push to your repository. "used to be chocolatey.org, but changed"
...
$global:au_GalleryUrl   = ''             #URL to package gallery, leave empty for Chocolatey Gallery/or if au_gallery is changed to private/public repo then leave blank as well.
